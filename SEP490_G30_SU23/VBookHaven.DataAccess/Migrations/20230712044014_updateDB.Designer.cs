...
namespace VBookHaven.DataAccess.Migrations
{
    ...
    [Migration("20230712044014_updateDB")]
            ...
            modelBuilder.Entity("VBookHaven.Models.Order", b =>
                {
                    ...
                    b.Property<int?>("ShippingInfoShipInfoId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ShippingInfoShipInfoId");
            ...
            modelBuilder.Entity("VBookHaven.Models.Order", b =>
                {
                    ...
                    b.HasOne("VBookHaven.Models.ShippingInfo", null)
                        .WithMany("Orders")
                        .HasForeignKey("ShippingInfoShipInfoId");
